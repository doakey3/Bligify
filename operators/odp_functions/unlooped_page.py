def unlooped_page(res_x, res_y, start, gif, end, aspect_ratio, 
    ...
    if border_thickness > 0:
        ...
        <draw:page draw:style-name="page_standard" draw:master-page-name="Default" presentation:presentation-page-layout-name="AL1T1">
            ...
            <draw:frame draw:style-name="image_unbordered" draw:layer="layout" svg:width="''' + str(img_w) + '''cm" svg:height="''' + str(img_h) + '''cm" svg:x="''' + str(img_x_pos) + '''cm" svg:y="''' + str(img_y_pos) + '''cm">
              <draw:image xlink:href="Pictures/''' + start + '''" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad">
                <text:p/>
              </draw:image>
            </draw:frame>
            
            <draw:frame draw:style-name="image_unbordered" draw:layer="layout" svg:width="''' + str(img_w) + '''cm" svg:height="''' + str(img_h) + '''cm" svg:x="''' + str(img_x_pos) + '''cm" svg:y="''' + str(img_y_pos) + '''cm" xml:id="id1">
              <draw:image xlink:href="Pictures/''' + end + '''" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad">
                <text:p/>
              </draw:image>
            </draw:frame>
            
            <draw:frame draw:style-name="image_unbordered" draw:layer="layout" svg:width="''' + str(img_w) + '''cm" svg:height="''' + str(img_h) + '''cm" svg:x="''' + str(img_x_pos) + '''cm" svg:y="''' + str(img_y_pos) + '''cm">
              <draw:image xlink:href="Pictures/''' + gif + '''" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad">
                <text:p/>
              </draw:image>
            </draw:frame>
            ...
            <anim:par presentation:node-type="timing-root">
                <anim:seq presentation:node-type="main-sequence">
                    <anim:par smil:begin="0s">
                        <anim:par smil:begin="0s">
                            <anim:par presentation:node-type="with-previous" presentation:preset-class="entrance" presentation:preset-id="ooo-entrance-appear" smil:begin="0.1s" smil:fill="hold">
                                <anim:set smil:attributeName="visibility" smil:begin="0s" smil:dur="0.001s" smil:fill="hold" smil:targetElement="id1" smil:to="visible"/>
                            </anim:par>
                        </anim:par>
                    </anim:par>
                </anim:seq>
